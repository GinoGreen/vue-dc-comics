   ...
   <section class="shortcut">
      ...
      <div class="container">
         ...
         <div class="row">
            ...
            <div class="thumb col-lg-2 col-md-3 col-sm-6 offset-lg-1 offset-md-2 offset-sm-0">
               <img src="../assets/img/buy-comics-digital-comics.png" alt="digital comics">
               <h4>digital comics</h4>
            </div>
            <div class="thumb col-lg-2 col-md-3 col-sm-6">
            ...
            <div class="thumb col-lg-2 col-md-3 col-sm-6 offset-lg-0 offset-md-3 offset-sm-0">
               <img src="../assets/img/buy-comics-subscriptions.png" alt="digital comics">
               <h4>subscription</h4>
            </div>
            <div class="thumb col-lg-2 col-md-3 col-sm-6 offset-md-0 offset-sm-3">
